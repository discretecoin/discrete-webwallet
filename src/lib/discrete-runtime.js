...
var DiscreteRuntime = (() => {
  ...
  function outputContext(inputsHash, kemCiphertext, outputIndex, subaddressIndex = 0n) {
  ...
  function scanPqOutput(output, inputsHash, viewSecretKey, spendPublicKey, subaddressIndex = 0n) {
    try {
